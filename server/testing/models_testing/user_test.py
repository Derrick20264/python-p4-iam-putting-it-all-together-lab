...
class TestUser:
    ...
    def test_has_attributes(self, test_app):
    ...
    def test_requires_username(self, test_app):
    ...
    def test_requires_unique_username(self, test_app):
    ...
    def test_has_list_of_recipes(self, test_app):
        ...
        with test_app.app_context():
            ...
            recipe_1 = Recipe(
                ...
                instructions="Ham him compass you proceed calling detract.",
                minutes_to_complete=60,
            )
            recipe_2 = Recipe(
                title="Hasty Party Ham",
                instructions="Really spring in extent an by. Judge but built gay party world.",
